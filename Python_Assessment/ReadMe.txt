Browser Used:
  Google Chrome version: Version 100.0.4896.60 (Official Build) (64-bit)
  Google Chrome Webdriver: Version 100.0.4896.60
...
To run blender_api.py on windows command prompt
C:\Program Files\Blender Foundation\Blender X.XX\blender --python C:\Python_Assessment\blender_api.py
